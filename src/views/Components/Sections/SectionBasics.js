  ...
  return (
    <div style={{padding:'3em'}}>
      ...
      <div style={{padding:'3em'}}>
        ...
        <Quote
          text="The American transportation system is embroiled in four major problems that show no signs of immediate improvement. Together, these issues present a major risk to people from all walks of life. "
